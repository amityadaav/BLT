...
const careerSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["new", "screening", "shortlisted", "interviewing", "offered", "hired", "rejected"],
      default: "new",
    },
...
// One application per email per position (case-insensitive)
careerSchema.index(
  { email: 1, position: 1 },
  { unique: true, collation: { locale: "en", strength: 2 } }
);
// One application per phone per position
careerSchema.index(
  { phone: 1, position: 1 },
  { unique: true }
);
